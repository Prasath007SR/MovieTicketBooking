          ...
          <MenuItem >Tirupur</MenuItem>
            ...
            <Avatar alt="Profile" src={Avata} />
                 ...
                 <Stack direction="row" sx={{gap:'75px'}}>
                    ...
                    <p className='exame'>
            <img alt="Veeran" src="https://m.media-amazon.com/images/M/MV5BMTJjN2NhY2EtYzZkOC00NDQ0LWFhMzEtNWZhYTFhNzNhNjllXkEyXkFqcGdeQXVyMTUyNjIwMDEw._V1_.jpg" height="500px" width={"500px"}  />  </p>
            <p class="j15">Movie Tickets → Movies → Good Night (U) -Tamil</p>
            <p>

          ...
          <MenuItem >Tirupur</MenuItem>
            ...
            <Avatar alt="Profile" src={Avata} />
                 ...
                 <Stack direction="row" sx={{gap:'75px'}}>
                    ...
                    <p className='exame'>
            <img alt="PS2" src="https://juksun.com/wp-content/uploads/2023/03/Ponniyin-Selvan-II-Movie-Poster.jpg" height="500px" width={"500px"}  />  </p>
            <p class="j15">Movie Tickets → Movies → PS2 (U) -Tamil</p>
            <p>
            <h4>About the movie:</h4>
            PS2 is a 2023 Indian Tamil-language romantic comedy film written and directed by Vinayak Chandrasekaran. The film stars K. Manikandan and Meetha Raghunath in the lead roles with Ramesh Thilak, Raichal rabecca, Balaji Sakthivel and Bagavathi Perumal portraying supporting roles</p>
                    </CardMedia>
...
Director: Mani ratnam<br></br><br></br>

          ...
          <MenuItem >Tirupur</MenuItem>
            ...
            <Avatar alt="Profile" src={Avata} />
                 ...
                 <Stack direction="row" sx={{gap:'75px'}}>
                    ...
                    <p className='exame'>
            <img alt="Veeran" src="https://m.media-amazon.com/images/M/MV5BZWFhZjBjY2ItMmZmMC00N2RjLTg2ZjktNDUwNmYwNmVjMDA5XkEyXkFqcGdeQXVyMjkxNzQ1NDI@._V1_FMjpg_UX1000_.jpg" height="500px" width={"500px"}  />  </p>
            <p class="j15">Movie Tickets → Movies → 2018 (U) -Tamil</p>
            <p>
